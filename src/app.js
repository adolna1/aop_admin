...
var prodact_1 = require("./entity/prodact");
var amqp = require("amqplib/callback_api");
var buffer_1 = require("buffer");
//łączenie z bazą
(0, typeorm_1.createConnection)().then(function (db) {
    var productRepository = db.getRepository(prodact_1.Product);
    //łączenie z amqps
    amqp.connect('amqps://cbbrvacj:mUve7u8T_NGHOJb71PTd4rhR9CMugzFa@rat.rmq2.cloudamqp.com/cbbrvacj', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        //tworzenie kanału
        connection.createChannel(function (error1, channal) {
            if (error1) {
                throw error1;
            }
            var app = express();
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            channal.sendToQueue('product_created', buffer_1.Buffer.from(JSON.stringify(result)));
            ...
            app.put('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            channal.sendToQueue('product_updated', buffer_1.Buffer.from(JSON.stringify(req.params.id)));
                            return [2 /*return*/, res.send(result)];
                    }
                });
            }); });
            app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            result = _a.sent();
                            channal.sendToQueue('product_deleted', buffer_1.Buffer.from(JSON.stringify(result)));
                            return [2 /*return*/, res.send(result)];
                    }
                });
            }); });
